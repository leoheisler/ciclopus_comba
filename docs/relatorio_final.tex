...
\begin{abstract}
\noindent
Este relatório descreve o projeto \textbf{Network Attack Detection Analysis}, uma plataforma de
...
de tráfego benigno, DDoS e PortScan. É possível visualizar a Dashboard e interagir com um passo a passo do pipeline por um notebook do \textit{Google Colab} que pode ser acessado no seguinte link: \url{https://colab.research.google.com/drive/173iGI5XBFS84VeBb2dzX2ITvanQlp6mW?usp=sharing}
\end{abstract}
...
Porém, estes resultados também relevam que estamos trabalhando com um dataset extremamente simples e não podemos esperar tamanha acurácia em um cenário real de segurança.
